// =============================================================
// CategoryPage - Shows subcategory and article list
...
import { ChevronRight, FileText, Tag, Calendar } from "lucide-react";
  ...
  return (
    <KBLayout
      breadcrumbs={[
        ...
        ...(activeSub ? [{ label: activeSub.title }] : []),
      ]}
    >
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="mb-6">
          <h1 className="text-xl font-bold text-slate-900 mb-1" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
            {cat.title} {activeSub ? `› ${activeSub.title}` : ""}
          </h1>
          <p className="text-slate-500 text-sm">{activeSub?.description || cat.description}</p>
        </div>
